...
unsigned int segments[] ={
  //  This respect the table for 7 segm like "hgfedcba"  // 
      0b00111111, //0   
      0b00000110, //1     
      0b01011011, //2   
      0b01001111, //3    
  ...
  delayMicroseconds(10);
      ...
      cmd_with_stb(0b01000000); // cmd 2 //Normal operation; Set pulse as 1/16
        ...
        cmd_without_stb((0b11000000) | 0x00); //cmd 3 wich define the start address (00H to 15H)
          ...
          //
          // The small board with the PT6964 and the SN8P2501B, have the sequence of GRID's as 0,4,1,3,2
          ...
          // Grid 4
          cmd_without_stb(numberC0);      // Minutes Units
          cmd_without_stb(numberC1);      // Only to used with digits drawed by 2 bytes.
          
          //
          // Grid 5
              if(flag==false){
              cmd_without_stb(0b11111011);  // space between digits (2 points???) // (0b00000100)top point between 2 digits at right 
